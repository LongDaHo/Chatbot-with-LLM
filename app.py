...
class CustomDataChatbot:
    ...
    def query_chain(self,chain_input):
        ...
        if len(stored_messages) == 0:
            return self.query_transforming_retriever_chain.invoke({"messages": [HumanMessage(chain_input["input"])]},)
        return self.query_transforming_retriever_chain.invoke({"messages": stored_messages + [HumanMessage(chain_input["input"])]},)   
